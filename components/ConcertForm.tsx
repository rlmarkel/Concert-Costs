...
import type { ConcertInsert, ConcertRow } from "@/lib/database.types";
...
export const emptyConcertForm: ConcertFormValues = {
  concert_name: "",
  artist: "",
  venue: "",
  city: "",
...
export function concertToFormValues(concert: ConcertRow): ConcertFormValues {
  return {
    ...
    ticket_cost: String(concert.ticket_cost),
...
export function ConcertForm({
  mode,
  concertId,
  initialValues = emptyConcertForm,
}: ConcertFormProps) {
  const router = useRouter();
  const supabase = createClient();
  const [form, setForm] = useState<ConcertFormValues>(initialValues);
  ...
  function updateField(key: keyof ConcertFormValues, value: string) {
